...
int main(void)
{
        ...
        for(int i=0;i<x;i++)
        {
          if(server_message[i]==' ' || i==x-1)
          {
            ...
            if(chk==0)
            {
               int k=count/2,g=i1-count,v=i1-1;
               char b;
               for(int j=0;j<k;j++,v--,g++)
               {
                 b=client_message[v];
                 client_message[v]=client_message[g];
                 client_message[g]=b;
               }
            }
            chk=0;
          ...
          if(server_message[i] == 'a' || server_message[i] == 'e' || server_message[i] == 'i' || server_message[i] == 'o' || server_message[i] == 'u')
          {
            chk=1;
          }
        }
